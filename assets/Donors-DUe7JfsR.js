import{r as m,j as e,d as p,u as A,L as D,a as S}from"./index-C0ojuvKQ.js";import{l as L,u as B}from"./api-Bu0U2RRx.js";import{u as C,a as G,o as E,s as x,b as O,_ as w}from"./zod-C_okCwJ9.js";import{n as F}from"./coerce-4DePUZ7N.js";function M({open:a,title:c,onClose:n,children:h,footer:o}){return m.useEffect(()=>{if(!a)return;const r=l=>l.key==="Escape"&&(n==null?void 0:n());return document.addEventListener("keydown",r),()=>document.removeEventListener("keydown",r)},[a,n]),a?e.jsx(u.Overlay,{onClick:n,children:e.jsxs(u.Box,{onClick:r=>r.stopPropagation(),children:[e.jsxs(u.Header,{children:[e.jsx("h3",{children:c}),e.jsx(u.Close,{onClick:n,"aria-label":"Close",children:"×"})]}),e.jsx(u.Body,{children:h}),o&&e.jsx(u.Footer,{children:o})]})}):null}const u={Overlay:p.div`
